...
components: in pages folder signup, register, login under views -->base Services----register service components under base:make request(redeem rewards), every-requests(user info) dashboard
